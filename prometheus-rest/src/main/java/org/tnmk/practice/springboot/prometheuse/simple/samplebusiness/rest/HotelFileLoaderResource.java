...
public class HotelFileLoaderResource {
    ...
    public String loadHotelFile(@RequestParam(value = "expectSuccess", required = false, defaultValue = ""+true) boolean expectSuccess) {
        return hotelFileLoaderUseCase.loadHotelFile(expectSuccess);
    }
}